...
@Composable
fun AdjustBottomBar(selected: Int, buttonState: String) {
    ...
    NavigationBar(containerColor = MaterialTheme.colorScheme.surfaceContainerHighest) {
        ...
        NavigationBarItem(
            ...
            icon = {
                Image(
                    painterResource(Res.drawable.speedplus), null, colorFilter = ColorFilter.tint(
                        MaterialTheme.colorScheme.onSurface), modifier = Modifier.size(24.dp))
            },
            label = { Text("") }
        )
        NavigationBarItem(
            ...
            icon = {
                Image(
                    painterResource(Res.drawable.fine_tune), null, colorFilter = ColorFilter.tint(
                        MaterialTheme.colorScheme.onSurface), modifier = Modifier.size(24.dp))
            },
            label = { Text("") }
        )
